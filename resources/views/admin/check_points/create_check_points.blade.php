	...
	<div class="row" style="margin-top:30px;">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="page-header">				
				<h2>Add Checkpoint</h2> <small></small>
			</div>
		</div>
	</div>
	<div class="row">
		...
		<div class="col-xs-12 col-sm-12 col-md-8 col-lg-4">
			<div class="panel panel-default panel-custom">
				<div class="panel-body">
					{{ Form::open(array('route' => ['settings.check.points.store'],'method' => 'POST','files' => true,'id'=>'checkpointForm')) }}
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-group {{ $errors->first('latitude') ? 'has-error' : '' }} ">
									...
									{{ Form::number('latitude',null,array('class'=>'form-control validate[required]','placeholder' => 'Latitude','step'=>'any')) }}
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-group {{ $errors->first('longitude') ? 'has-error' : '' }} ">
									...
									{{ Form::number('longitude',null,array('class'=>'form-control validate[required]','placeholder' => 'Longitude','step'=>'any')) }}
