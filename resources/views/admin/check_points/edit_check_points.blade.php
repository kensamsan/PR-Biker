	...
	<div class="row" style="margin-top:30px;">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="page-header">				
				<h2>Edit Checkpoint</h2> <small></small>
			</div>
		</div>
	</div>
	<div class="row">
		...
		<div class="col-xs-12 col-sm-12 col-md-8 col-lg-4">
			<div class="panel panel-default panel-custom">
				<div class="panel-body">
					{{ Form::open(array('route' => ['settings.check.points.update','id' => $check_point->id],'method' => 'PUT','files' => true,'id'=>'checkpointForm')) }}
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-group {{ $errors->first('name') ? 'has-error' : '' }} ">
									{{ Form::label('name', 'Name', array('class'=>'control-label')) }}
									{{ Form::text('name',$check_point->name,array('class'=>'form-control validate[required]','placeholder' => 'Name')) }}
									@if($errors->has('name'))
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-group {{ $errors->first('latitude') ? 'has-error' : '' }} ">
									...
									{{ Form::number('latitude',$check_point->latitude,array('class'=>'form-control validate[required]','placeholder' => 'Latitude','step'=>'any')) }}
									@if($errors->has('latitude'))
										<p class="help-block text-danger">{{$errors->first('latitude')}}</p>
									@endif
								</div>	
							</div>
						</div>
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-group {{ $errors->first('longitude') ? 'has-error' : '' }} ">
									...
									{{ Form::number('longitude',$check_point->longitude,array('class'=>'form-control validate[required]','placeholder' => 'Latitude','step'=>'any')) }}
									@if($errors->has('longitude'))
										<p class="help-block text-danger">{{$errors->first('longitude')}}</p>
									@endif
								</div>	
							</div>
						</div>
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="pull-right">
									<a href="{{route('settings.check.points.index')}}" class="btn btn-default btnCancel">Cancel</a>
...
<script>
	$(document).ready(function(){
		...
		@endif
		$('#checkpointForm').on('click','.btnSubmit',function(){
