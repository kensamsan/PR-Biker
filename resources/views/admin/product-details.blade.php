    ...
    <div class="container-fluid px-0">
        <div class="d-flex flex-row px-0 mx-0">
            ...
            <div class="col-lg px-0">
                ...
                <!-- Main Conent -->
                <caption><h2 class="pt-3 pl-3" style="font-weight: 900;"><span><a href="products.html" ><img src="Images/arrow-down-sign-to-navigate.png"  style="width: 15px;"></a></span> Product Details</h2></caption>
                <p class="dashed"></p>
