	...
	<div class="row" style="margin-top:30px;">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="page-header">				
				<h2>Edit Purpose</h2> <small></small>
			</div>
		</div>
	</div>
	<div class="row">
		...
		<div class="col-xs-12 col-sm-12 col-md-8 col-lg-4">
			<div class="panel panel-default panel-custom">
				<div class="panel-body">
					{{ Form::open(array('route' => ['settings.purpose.types.update','id'=>$purpose_type->id],'method' => 'PUT','files' => true,'id'=>'purposeForm')) }}
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-group {{ $errors->first('name') ? 'has-error' : '' }} ">
									{{ Form::label('name', 'Name', array('class'=>'control-label')) }}
									{{ Form::text('name',(!empty($errors->any()) ? old('name') : $purpose_type->name),array('class'=>'form-control validate[required]','placeholder' => 'Name')) }}
									@if($errors->has('name'))
