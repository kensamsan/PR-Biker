...
@section('body')
    ...
    <h3 class="ps-2 pt-4 pb-2 fs-2"><a href="/products"><i class="fas fa-chevron-left me-3 text-dark"></i></a><b>Add
            Product</b></h3>
    <p class="dashed"></p>
    <div class="col-lg-7">
        <section class="mx-4">
            ...
            <textarea class="form-control product-textarea w-100" id="exampleFormControlTextarea1" rows="3"></textarea>
