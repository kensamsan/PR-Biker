...
<head>
    ...
    <link rel="stylesheet" href="/css/admin/costumer.css">
    <!-- Bootstrap CSS -->
    ...
    <div class="container-fluid px-0">
        <div class="d-flex flex-row px-0 mx-0">
            <div class="col-lg-2 px-0">
                ...
                <nav class="side-menu d-flex flex-column px-0 mx-0">
                    ...
                    <div class="menu-links d-flex flex-column pt-2 font-weight-bold">
                        ...
                        <a class="pl-4 mt-2 " href=""><small>Customers</small></a>
                    </div>
            ...
            <div class="col-lg px-0">
                ...
                <!-- Main Conent -->
                <caption><h2 class="pt-3 pl-3" style="font-weight: 900;">Costumers</h2></caption>
                <p class="dashed"></p>
                <div class="card">
                  <div class="card-body">
                    <table>
                        <h4 style="font-weight: 900; color: #707070;">Costumers List</h4>
                        <tr>
                          <th>ID</th>
                          <th>NAME</th>
                          <th>CONTACT</th>
