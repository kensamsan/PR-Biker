		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="page-header d-flex">
				<span class="align-items-center d-flex">
					...
					<h2 class="margin-left-sm" style="margin:0px;">Add Category</h2>
				</span>					
			</div>
		</div>
	</div>
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="panel panel-default panel-custom">
				...
				<div class="panel-body" style="padding:0px;">
					{{ Form::open(array('route' => 'categories.store', 'method' => 'store','files'=>true)) }}
						<div class="row">
							<div class="col-lg-11 margin-left margin-bottom margin-top">
								{{ Form::label('category_name', 'Category Name') }}
								{{ Form::text('category_name','',array('class'=>'form-control span6','placeholder' => 'Category Name')) }}
