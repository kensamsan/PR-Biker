...
@section('content')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(['route' => ['admin.order.cancel', $rental->id], 'method' => 'store', 'files' => true]) }}
                    <p>Are you sure you want to Cancel this Order?</p>
                    <input type="hidden" name="order_id" value="{{ $rental->id }}">
                    <div class="row">
                        <div class="col-lg-12">
                            {{ Form::label('note', 'Note') }}
                            {{ Form::text('note', '', ['class' => 'form-control span6', 'placeholder' => 'Note']) }}
    ...
    <div class="modal fade" id="courier" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    {{ Form::open(['route' => ['admin.order.ship', $rental->id], 'method' => 'store', 'files' => true]) }}
                    <input type="hidden" name="order_id" value="{{ $rental->id }}">
                    <div class="row">
                        <div class="col-lg-12">
                            {{ Form::label('courier', 'Courier') }}
                            {{ Form::text('courier', '', ['class' => 'form-control span6', 'placeholder' => 'Courier']) }}
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            {{ Form::text('tracking', '', ['class' => 'form-control span6', 'placeholder' => 'tracking']) }}
    ...
    <div class="modal fade" id="recourier" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    {{ Form::open(['route' => ['admin.order.reship', $rental->id], 'method' => 'store', 'files' => true]) }}
                    <input type="hidden" name="order_id" value="{{ $rental->id }}">
                    <div class="row">
                        <div class="col-lg-12">
                            {{ Form::label('courier', 'Courier') }}
