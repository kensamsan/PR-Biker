										...
										<td>
											<div class="btn-group">
					                            ...
					                            <ul class="dropdown-menu dropdown-menu-right">
					                            	...
					                            	<li>
					                                    <a target="_blank" href="/uploads/deposit/{{$p->getDepositImage() }}" ><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>&nbsp; View Deposit</a>
					                                </li>

					                                <li>
					                                    <a target="_blank" href="{{route('admin-rentals.approve-payment',$p->id)}}" ><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>&nbsp; Approve Payment</a>
					                                </li>
					                            	...
					                            	<li>
					                                    <a href="{{route('admin-rentals.delivered',$p->id)}}" ><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>&nbsp; SET Delivered</a>
					                                </li>
					                            	...
					                            	<li>
					                                    <a href="{{route('admin-rentals.approve',$p->id)}}" ><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>&nbsp; Approve</a>
					                                </li>
				                                	...
				                                	<li>
					                                    <a href="{{route('admin-rentals.cancel',$p->id)}}" ><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>&nbsp; Cancel</a>
					                                </li>
