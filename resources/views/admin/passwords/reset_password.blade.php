...
<html>
    <head>
        ...
        <title>Reset Password | {{Session::get('software_name')}}</title>
                                                ...
                                                <div class="left-third-inner-left-column">
                                                    {{-- <div class="title-row-flex">
                                                        ...
                                                        <div style="flex:9;-webkit-box-flex: 9;-moz-box-flex: 9;-webkit-flex: 9;-ms-flex: 9;">
                                                            <div style="height:100%;display:flex;display: -webkit-box;display: -ms-flexbox;display: -webkit-flex;-webkit-flex-direction: column;-ms-flex-direction: column;flex-direction: column;-webkit-box-orient: vertical;-moz-box-orient: vertical;align-items: stretch;">
                                                                <div>   
                                        ...
                                        <div class="right-third-column">   
                                            <div class="panel panel-default">   
                                                <div class="panel-body" style="padding: 30px 35px 30px 35px;"> 
                                                    {{ Form::open(array('route' => ['user.forgot.reset.password.update','token'=>$tokenData->token,'email'=>$tokenData->email],'id'=>'resetPasswordEmailForm')) }}
                                                    <div style="height:100%;display:flex;display: -webkit-box;display: -ms-flexbox;display: -webkit-flex;-webkit-flex-direction: column;-ms-flex-direction: column;flex-direction: column;-webkit-box-orient: vertical;-moz-box-orient: vertical;align-items: stretch;">
                                                        <div style="flex:10;-webkit-box-flex: 10;-moz-box-flex: 10;-webkit-flex: 10;-ms-flex: 10;">
                                                            <div style="padding-bottom: 5px;">   
                                                                <span class="login-text">Reset Password</span>
                                                                <p style="font-size: 1.2em;">Please enter your new password.</p>
                                                                ...
                                                                <div class="form-group">   
                                                                    {{ Form::password('new_password_confirmation',array('class'=>'form-control validate[equals[pass]]','placeholder' => 'Repeat Password')) }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div style="flex:1;-webkit-box-flex: 1;-moz-box-flex: 1;-webkit-flex: 1;-ms-flex: 1;"> 
                                                            @if(count($errors->all()) > 0)
                                                                    <p class="text-center text-danger">{{$errors->has('new_password') ? $errors->first('new_password') : '&nbsp;'}} </p>
