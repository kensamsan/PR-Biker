...
@section('css')
    <style type="text/css">
        ...
        .anchor-panel-card,
        .anchor-panel-card:focus,
        .anchor-panel-card:hover {
            color: black;
                        ...
                        <div class="panel-body">
                            <div class="row equal">
                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4" style="align-self: center;">
                                    <img src="{{ asset('uploads/icons/green-check-circle.png') }}"
                                        class="img-responsive img-circle" alt="total-cases-icon">
                                </div>
                ...
                <a href="#" class="anchor-panel-card">
                    <div class="panel panel-default panel-card panel-total">
                        <div class="panel-body">
                            <div class="row equal">
                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4" style="align-self: center;">
                                    <img src="{{ asset('uploads/icons/checklist-light-blue.png') }}"
                                        class="img-responsive img-circle" alt="total-cases-icon">
                                </div>
                                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                    <div class="flex-row-vertical">
                ...
                <a href="#" class="anchor-panel-card">
                    <div class="panel panel-default panel-card panel-total">
                        <div class="panel-body">
                            <div class="row equal">
                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4" style="align-self: center;">
                                    <img src="{{ asset('uploads/icons/gray-rotation.png') }}"
                                        class="img-responsive img-circle" alt="total-cases-icon">
                                </div>
                                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                    <div class="flex-row-vertical">
                ...
                <a href="#" class="anchor-panel-card">
                    <div class="panel panel-default panel-card panel-total">
                        <div class="panel-body">
                            <div class="row equal">
                                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4" style="align-self: center;">
                                    <img src="{{ asset('uploads/icons/blue-paper-plane.png') }}"
                                        class="img-responsive img-circle" alt="total-cases-icon">
                                </div>
                                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                    <div class="flex-row-vertical">
