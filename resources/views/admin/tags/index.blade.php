				...
				<div class="panel-heading">
					<div class="row">
						<div class="col-xs-12 col-sm-8 col-md-3 col-lg-3">
							{{ Form::open(array('route' => 'admin.tag.index', 'method' => 'get')) }} 
						...
						<div class="col-xs-12 col-sm-4 col-md-4 col-lg-2">
							<a class="btn btn-success addBtn" href="{{route('admin.tag.create')}}">
								...
								<tr style="border: 1px solid black;">
									...
									<td>
										<div class="btn-group" role="group" aria-label="...">
											@if($x->active==0)
												<a  class="btn btn-danger " href="{{ route('admin.tag.active',$x->id) }}"><i class="fas fa-pencil-alt"></i> Toggle</a>
											@else
												<a  class="btn btn-success " href="{{ route('admin.tag.inactive',$x->id) }}"><i class="fas fa-pencil-alt"></i> Toggle</a>
											@endif

											<a  class="btn btn-default " href="{{ route('admin.tag.edit',$x->id) }}"><i class="fas fa-pencil-alt"></i> Edit</a>				
									<!-- 		<a  class="btn btn-danger btnDeleteGrade" href="#" id="{{$x->id}}" data-toggle="modal" data-target="#confirmationGrade"><i class="fas fa-times-circle"></i> Delete</a>	 -->				
										</div>
									</td>
								</tr>
								@endforeach 
