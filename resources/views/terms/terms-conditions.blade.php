...
<div class="container-fluid mb-5 m-sm-0 ms-6">
    <p>Welcome to bikers.com.ph!</p>

    <p>These terms and conditions outline the rules and regulations for the use of bikers's Website, located at
        https://bikers.com.ph.</p>

    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use bikers.com.ph
    ...
    <p>We employ the use of cookies. By accessing bikers.com.ph, you agreed to use cookies in agreement with the
        bikers's Privacy Policy. </p>
    ...
    <p>Unless otherwise stated, bikers and/or its licensors own the intellectual property rights for all material on
        bikers.com.ph. All intellectual property rights are reserved. You may access this from bikers.com.ph for
        your own personal use subjected to restrictions set in these terms and conditions.</p>

    <p>You must not:</p>
    <ul>
        <li>Republish material from bikers.com.ph</li>
        <li>Sell, rent or sub-license material from bikers.com.ph</li>
        <li>Reproduce, duplicate or copy material from bikers.com.ph</li>
        <li>Redistribute content from bikers.com.ph</li>
    </ul>
    ...
    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
        areas of the website. bikers does not filter, edit, publish or review Comments prior to their presence on the
        website. Comments do not reflect the views and opinions of bikers,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
        applicable laws, bikers shall not be liable for the Comments or for any liability, damages or expenses caused
        and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
    </p>

    <p>bikers reserves the right to monitor all Comments and to remove any Comments which can be considered
    ...
    <p>You hereby grant bikers a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
        ...
        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of bikers;
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
        must inform us by sending an e-mail to bikers. Please include your name, your organization name, contact
    ...
    <p>No use of bikers's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
