    ...
    <style>
        * {
        ...
        @media (min-width: 768px){
            ...
            .navbar-inverse .navbar-right>li>a:hover,.navbar-inverse .navbar-right>li>a:focus,.navbar-inverse .navbar-right>li>a:active {
                background: #252529;
                color:#e7e7e7;
            }
            ...
            .dropdown-right>.active>a, .dropdown-right>.active>a:focus, .dropdown-right>.active>a:hover {
        ...
        .navbar-inverse .side-nav>li>a:active:hover,.navbar-inverse .side-nav>li>a:active:focus,.navbar-inverse .side-nav>li>a:focus
        {
            background-color: transparent !important;
        }
        ...
        .navbar-nav>li>a.btn-menu,.navbar-nav>li>a.btn-menu:focus
        {
            color:#000000;
            font-size:16px;
        }
        .navbar-nav>li>a.btn-menu:hover, .navbar-nav>li>a.btn-menu:active
        {
            color:#0063e0;
        }
        @media(min-width: 768px)
        ...
        @media(min-width: 768px)
        {
            .aguora-footer-big
            {
                bottom:0;left:0;position:fixed;width:251px;color:#f5f5f5;
            }
        }
        ...
        @media(min-width: 236px)
        {
            .navbar-brand
            {
                width:251px;letter-spacing: 4.6px;
            }
        }
        .swal2-popup {
...
<body style="background-color:#f5f5f5;">
    ...
    <div id="wrapper"> 
        ...
        <!-- Navigation -->
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.2), 0 2px 5px 0 rgba(0, 0, 0, 0.19);">
            ...
            <ul class="nav navbar-nav navbar-right hidden-xs" style="margin-right:0px;">
                    <li class="dropdown">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="font-size:20px;">
                       <img src="{{asset('/uploads/users/'.Auth::user()->photo)}}" class="img-responsive pull-left img-circle text-center" style="display:block;margin-top:-2px;margin-right:5px;height:30px;width:30px;"> {{ Auth::user()->username }} <i class="fas fa-fw fa-caret-down"></i>
                      </a>
                      <ul class="dropdown-menu dropdown-right">
                        ...
                        <li ><a href="{{route('logout')}}"><i class="fas fa-fw fa-sign-out-alt"></i> Logout</a></li>
                      </ul>
                    </li>
            </ul>
            <div class="collapse navbar-collapse navbar-ex1-collapse" >
                <ul class="nav navbar-nav side-nav show-side" style="color:white !important;">
                    ...
                    <li class="{{(\Request::route()->getName() == 'admin.orders.index' || \Request::route()->getName() == 'admin.orders.edit' || \Request::route()->getName() == 'admin.orders.show') ? 'active' : ''}}">
                            <a href="{{route('admin.orders.index')}}">Orders</a>
                    </li>

                    <li class="{{(\Request::route()->getName() == 'users.index' || \Request::route()->getName() == 'users.edit' || \Request::route()->getName() == 'users.show') ? 'active' : ''}}">
                            <a href="{{route('users.index')}}">Users</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.promo-codes.index') }}"><i class="fa fa-bullhorn"></i>&nbsp; Promo Code</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.tag.index') }}">Tags</a>
                    </li>

                    <li class="" id="listSettings"><a href="javascript:;" data-toggle="collapse" data-target="#listings" >Listings <i class="fa fa-fw fa-caret-left pull-right" id="caret-icon"></i></a>
                        <ul id="listings" class="collapse {{(\Request::route()->getName() == 'activity_logs.index' || \Request::route()->getName() == 'settings.index' ) ? 'in' : ''}}">
                    ...
                    <li class="hidden-md hidden-sm hidden-lg {{(\Request::route()->getName() == 'profile') ? 'active' : ''}}">
                        <a href="javascript:;" data-toggle="collapse" data-target="#logged_user"><img src="{{asset('/uploads/users/'.Auth::user()->photo)}}" class="img-responsive pull-left img-circle text-center" style="display:block;margin-top:-2px;margin-right:5px;top:5px;height:25px;width:25px;"> {{ Auth::user()->username }} <i class="fas fa-fw fa-caret-down"></i></a>
                        <ul id="logged_user" class="collapse {{(\Request::route()->getName() == 'profile') ? 'in' : ''}}">
                    ...
                    <li class="hidden-md hidden-sm hidden-lg text-center aguora-footer-small" style="margin-top:10px;">
                         <p class="text-footer" style="color:white;font-size:11px;"> &#9400; 2019 {{Session::get('company_name')}}</p>
                    </li>
