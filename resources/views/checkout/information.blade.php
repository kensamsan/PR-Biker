            ...
            {{ Form::open(array('route' => 'client-checkout-shipping', 'method' => 'get' ,'id'=>'submitForm')) }}
                <div class="row justify-content-center mb-5 pb-5">
                    ...
                    <div class="col-lg-5 px-5 my-3 checkout-form">
                        ...
                        <p style="color: #707070">Contact Number <a href="#" class="updateNum" data-toggle="modal" data-target="#myModalNumber" style="color: #F2B533"><strong>@if(Auth::user()->contact=='') Add Number @else Update Number @endif </strong></a></p>
                       ...
                       <p style="color: #707070">Select a shipping address from your address book or <br><a href="#" data-toggle="modal" data-target="#myModal" style="color: #F2B533"><strong>enter new address</strong></a></p>
                        <div class="row my-3">
                            <div class="col">
                    ...
                    <div class="col-lg-5 px-5 my-3">
                        ...
                        <hr>
                        <p class="px-2"><span class="text-bold">SUBTOTAL</span><span class="float-right">₱ {{ number_format(\Cart::session(Auth::user()->id)->getSubTotal(),2) }}</span></p>
                    </div>
                </div>
            </form>
        </div>
