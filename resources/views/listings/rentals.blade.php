    ...
    <div class="row my-auto">
        ...
        <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('listings-show',[$x->id]) }}"><button  class="btn btn-details form-control">View</button></a>
                        @if($x->status=='waiting')
                            <a href="{{ route('listing-deposit',$x->id) }}"><button type="button" class="btn btn-green form-control">Upload Deposit Slip</button></a>
                            @endif
                    </td>
                </tr>
                @endforeach
