...
<head>
    ...
    <title>Travel Pass Document | {{Session::get('software_name')}}</title>
	...
	<div class="container-fluid" style="margin-bottom: 0.39in;margin-top:0.39in;">
		<div class="row flex-row">
			<div class="col-xs-offset-1 col-xs-2">
				<img src="{{asset('uploads/santiago_city.png')}}" style="margin:0 auto;height:105px;width:100%;">
			</div>
            <div class="col-xs-6">
                <div class="" style="align-items: center;width:100%;height: 100%;">
                    <p class="text-center" style="width:100%;font-size:16px;font-family: garamond;">Republic of the Philippines</p>
                    <p class="text-center" style="width:100%;font-size:16px;font-family: garamond;font-weight: bold;">CITY OF SANTIAGO</p>
                    <p class="text-center" style="width:100%;font-size:14px;font-family: garamond;font-weight: bold;">LOCAL TASK FORCE AGAINST COVID-19</p>
                </div>
            </div>
            <div class="col-xs-3">
                <img src="{{asset('uploads/balamban.png')}}" height="105px" width="234" style="margin-left: -50px;">
            </div>
		</div>
        ...
        <div class="row">
            <div class="col-xs-10 col-xs-offset-1">
                <div class="text-center">
                    <h5 style="font-size:15px;font-family: Century Gothic;font-weight: bold;margin-bottom: 20px;">TRAVEL PASS<br>{{\Carbon\Carbon::parse($travel_pass->created_at)->format('Y')}}-{{\Carbon\Carbon::parse($travel_pass->created_at)->format('m')}}-{{\Carbon\Carbon::parse($travel_pass->created_at)->format('d')}}-{{!empty($travel_pass->tracking_no) ? substr($travel_pass->tracking_no,8) : 'xxxx-xx-xx-xxx'}}</h5>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-xs-10 col-xs-offset-1">
                <p style="text-indent:25px;font-family: Century Gothic;text-align: justify;">
        ...
        <div class="row">
            <div class="col-xs-10 col-xs-offset-1">
                ...
                <ol style="font-family: Century Gothic;">
                    <li>With BHERT Health Declaration and Medical Certification</li>
                    <li>Travel Details
                        <ol style="list-style-type: lower-alpha;font-family: Century Gothic;">
        ...
        <div class="row" style="margin-top:40px;">
            <div class="col-xs-offset-1 col-xs-5">
                <div class="row">
                    <div class="col-xs-12">
                        <div>
                            ...
                            <p style="margin-bottom: 0px;"><b>ENGR. PAULINO M. TAN</b></p>
                            <p style="margin-bottom: 0px;">City Administrator</p>
                ...
                <div class="row" style="margin-top:90px;">
                    <div class="col-xs-12">
                        <p style="border-top: 1px solid black;"><b>Printed Name and Signature of Applicant</b></p>
                    </div>
                </div>
            </div>
            <div class="col-xs-offset-2 col-xs-3">
                <div class="qr-div text-center">
                    <p style="margin-bottom: 0px;">Scan QR Code To Verify</p>
                    <img src="{{asset('uploads/qrcode/'.$travel_pass->tracking_no.'.png')}}" class="img-responsive" width="125" height="125" style="margin:0 auto;border: 2px solid #9a191f;">
                </div>
            </div>
        </div>
        <div class="row" style="margin-top:45px;">
            <div class="col-xs-offset-1 col-xs-10">
                <p style="color:#FF3333 !important;font-size:0.8em"><b>**The bearer of this document is required to closely coordinate with the BHERT for Monitoring</b></p>
            </div>
        </div>
        <hr style="border-color:black;margin-bottom: 0px;">
        <div class="row">
            <div class="col-xs-offset-1 col-xs-5">
                <p>CITY GOVERNMENT OF SANTIAGO<br>City Hall, San Andres, Santiago City</p>
            </div>
            <div class="col-xs-5">
                <p style="text-align: right;">Tel. No.: (078) 305-1104<br>Telefax No.: (078) 305-2770</p>
            </div>
        </div>
	</div>
