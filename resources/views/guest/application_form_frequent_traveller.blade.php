...
<head>
    ...
    <title>Application Form For Frequent Traveller | {{Session::get('software_name')}}</title>
    ...
    <div class="container-fluid">
        <div class="row" style="padding-top:15px;padding-bottom: 15px;">
            <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                {{ Form::open(array('route' => 'registration.frequent.traveller.store','files' => true,'id'=>'registrationForm')) }}
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group text-center" style="margin-bottom: 30px;">
                                        <h5 class="text-description">APPLICATION FORM FOR FREQUENT TRAVELLER</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group {{ $errors->first('rapid_test_result') ? 'has-error' : '' }}">
                                        <label class="control-label"><span>*</span>Rapid Test Result</label>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#registrationForm').on('click','.btnSubmit',function(){
                ...
                $(this).siblings('.btn').prop('readonly',true);
            ...
            //     }
            // });
            // $('input[name="contact_no"]').inputmask('mask', {'mask' : "+63999-999-9999","clearIncomplete": true,'removeMaskOnSubmit' : true});
