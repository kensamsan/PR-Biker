...
<head>
    ...
    <title>Travel Pass QR Code | {{Session::get('software_name')}}</title>
    ...
    <style type="text/css">
        ...
        .first-border-top
        {
            margin-top:0px;margin-bottom: 20px;border-top: 20px solid #9a191f;
        }
        .first-row
        {
            margin-bottom: 40px;
...
<body>
    <div class="container-fluid">
        ...
        <div class="row first-row">
            <div class="col-xs-4">
                <img src="{{asset('uploads/balamban.png')}}" style="max-height: 220px;display:block;margin:0 auto;">
            </div>
            <div class="col-xs-4">
                <img src="{{asset('uploads/covid.png')}}" style="max-height: 180px;display:block;margin:0 auto;">
            </div>
            <div class="col-xs-4">
                <img src="{{asset('uploads/Ambisyon 2040 Logo.png')}}" style="max-height: 300px;display:block;margin:0 auto;margin-top: -40px;">
            </div>
        </div>
            ...
            <div class="col-xs-6 col-xs-offset-3">
                <div class="row">
                    <div class="col-xs-offset-3 col-xs-6">
                        <img src="{{asset('uploads/santiago_city.png')}}"  class="img-responsive santiago-image">
                    </div>
                </div>
            </div>
        </div>
        <div class="row fifth-row" style="margin-bottom: 20px;">
            <div class="col-xs-12">
                <div class="text-center">
                    <p class="santiago-city-text"><strong>SANTIAGO CITY</strong></p>
                </div>
            </div>
        </div>
    </div>
