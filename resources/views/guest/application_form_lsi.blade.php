...
<head>
    ...
    <title>Application Form For LSI | {{Session::get('software_name')}}</title>
...
<body>
    <div class="container-fluid">
        <div class="row" style="padding-top:15px;padding-bottom: 15px;">
            <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
                {{ Form::open(array('route' => 'registration.lsi.store','files' => true,'id'=>'registrationForm')) }}
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group text-center" style="margin-bottom: 30px;">
                                        <h5 class="text-description">APPLICATION FORM FOR LSI</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            @endif
            @if($errors->any())
                @if((!empty($errors->first('government_id')) && (strcasecmp($errors->first('government_id'),'The government id may not be greater than 2000 kilobytes.') == 0)) || (!empty($errors->first('bhert_health_declaration')) && (strcasecmp($errors->first('bhert_health_declaration'),'The bhert health declaration may not be greater than 2000 kilobytes.') == 0)))
                    Swal.fire(
                        'There is an error.',
