    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="ms-5 ms-sm">
                ...
                <div class="row my-2">
                    <div class="col-lg-3">
                        <a href="#"class="px-5 mt-3 btn btn-background fw-bold text-uppercase lead text-light">buy now</a>
                    </div>
                    <div class="col-lg-3">
                        <a href="#"class="px-5 mt-3 btn btn-custom-outline text-uppercase lead text-light">add to cart</a>
                    </div>
                </div>
                {{-- Meet the seller --}}
                <div class="row mt-4">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control w-60 w-sm-80 remove-resize" rows="4"></textarea>
                </div>
                <div class="row justify-content-end">
                    <div class="col-lg-4">
                        <a href=""class="btn btn-background fw-bold text-uppercase lead text-light">post comment</a>
                    </div>
                </div>
                {{-- Similar listings --}}
                <div class="row my-5">
                        ...
                        <div class="col-lg-3 col-md-6 col-12 pt-4">
                            <div class="card card-course">
                                ...
                                <div class="card card-course-foot shadow border-0">
                                    <button class="btn-background text-light mx-auto fst-italic btn border-0 fs-5 p-2">
                                        Other Details
                                    </button>
                                </div>
                            </div>
